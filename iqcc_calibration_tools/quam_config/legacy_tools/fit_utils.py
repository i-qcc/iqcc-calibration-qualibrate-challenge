...
from iqcc_calibration_tools.quam_config.legacy_tools.fit import peaks_dips
...
def fit_resonator_purcell(
    s21_data: xr.Dataset, init_J: float = 15e6, init_kappa_p: float = 10e6, print_report: bool = False
):
