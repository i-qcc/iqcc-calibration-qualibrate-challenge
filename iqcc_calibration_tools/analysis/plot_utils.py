...
def plot_ar_attempts(ar_data: dict[str, np.typing.NDArray], **hist_kwargs):
    ...
    Example:
        ...
        from iqcc_calibration_tools.analysis.plot_utils import plot_ar_attempts
        ar_dat = {}
...
class QubitPairGrid:
    ...
    '''
    from iqcc_calibration_tools.quam_config.lib.qua_datasets import grid_iter
...
class QubitGrid:
    ...
    '''
    from iqcc_calibration_tools.quam_config.lib.qua_datasets import grid_iter, QubitGrid
    grid = QubitGrid(ds)
    ...
    '''
    from iqcc_calibration_tools.quam_config.lib.qua_datasets import grid_iter, QubitGrid, grid_names
